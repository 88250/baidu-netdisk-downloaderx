...
type DownloadFunc func(downloadURL string, jar *cookiejar.Jar) (speed int64, err error)

// DownloadFile 下载单个文件
func (pcs *BaiduPCS) DownloadFile(path string, downloadFunc DownloadFunc) (speed int64, err error) {
	pcs.lazyInit()
...
func (pcs *BaiduPCS) DownloadStreamFile(path string, downloadFunc DownloadFunc) (speed int64, err error) {
	pcs.lazyInit()
